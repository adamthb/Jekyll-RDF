# -*- encoding: utf-8 -*-
# stub: jekyll-rdf 3.0.1.pre.develop.597 ruby lib

Gem::Specification.new do |s|
  s.name = "jekyll-rdf".freeze
  s.version = "3.0.1.pre.develop.597"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Elias Saalmann".freeze, "Christian Frommert".freeze, "Simon Jakobi".freeze, "Arne Jonas Pr\u{e4}ger".freeze, "Maxi Bornmann".freeze, "Georg Hackel".freeze, "Eric F\u{fc}g".freeze, "Sebastian Z\u{e4}nker".freeze, "Natanael Arndt".freeze, "Simon Bin".freeze, "Jan Beckert".freeze]
  s.date = "2018-11-17"
  s.description = "Generate static sites with Jekyll based on RDF data".freeze
  s.email = "arndt@informatik.uni-leipzig.de".freeze
  s.homepage = "https://github.com/white-gecko/jekyll-rdf".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sparql>.freeze, [">= 2.2.1", "~> 2.2"])
      ...
      s.add_dependency(%q<sparql>.freeze, [">= 2.2.1", "~> 2.2"])
